...
long  mushscaling = 8191;	// range variabilitÖ (in bitmask) "greenmush"
...
int   rockdensity = 15;		// densitÖ gruppi di rocce (bitmask).
...
void build_surface ()
{
	...
	switch (nearstar_p_type[ip_targetted]) {
		...
		case 7: // gelidi, solcati di strie.
			...
			n /= 2; while (n) { // ma sç, anche qualche crepetta pió piccola, sparsa...
